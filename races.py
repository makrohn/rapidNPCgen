            ...
            "Powers": [
                {
                    ...
                    "Text": "You have advantage on saving throws against "
                            "poison, and you have resistance against poison "
                            "damage"
                },
                {
                    "Name": "Stonecunning",
                    "Text": "Whenever you make an Intelligence (History) "
                            "check related to the origin of stonework, you "
                            "are considered proficient in the History skill "
    ...
    "Elf":
        {
            ...
            "Powers": [
                ...
                {
                    "Name": "Trance",
                    "Text": "Elves don’t need to sleep. Instead, they "
    ...
    "Halfling":
        {
            ...
            "Powers": [
                {
                    "Name": "Lucky",
                    "Text": "When you roll a 1 on an attack roll, ability "
                ...
                },
                {
                    ...
                    "Text": "You can move through the space of any creature "
            ...
            "Powers": [
                ...
                },
                {
                    ...
                    "Text": "You can use your action to exhale destructive "
                            ...
                            "proficiency bonus. A creature takes 2d6 damage "
                            "on a failed save, and half as much damage on a "
                            "successful one. The damage increases to 3d6 at "
                            "6th level, 4d6 at 11th level, and 5d6 at 16th "
                            "level."

                },
                {
                    "Name": "Damage Resistance",
                    "Text": "You have resistance to the damage type "
    ...
    "Gnome":
        {
            ...
            "Powers": [
                {
                    "Name": "Gnome Cunning",
                    "Text": "You have advantage on all Intelligence, Wisdom, "
            ...
            "Powers": [
                {
                    ...
                    "Text": "When you are reduced to 0 hit points but not "
                ...
                {
                    "Name": "Savage Attacks",
                    "Text": "When you score a critical hit with a melee "
                            "weapon attack, you can roll one of the weapon’s "
                            "damage dice one additional time and add it to "
    ...
    "Tiefling":
        {
            ...
            "Powers": [
                ...
                },
                {
                    ...
                    "Text": "You know the thaumaturgy cantrip. Once you reach "
                            "3rd level, you can cast the hellish rebuke spell "
                            "once per day as a 2nd-level spell. Once you "
                            "reach 5th level, you can also cast the darkness "
                            "spell once per day. Charisma is your "
...
def subrace_dwarf(subrace):
    ...
    if "Hill" in subrace:
        RACE_DEFINITIONS["Dwarf"]["Abilities"]["Wisdom"] = 1
    elif "Mountain" in subrace:
        RACE_DEFINITIONS["Dwarf"]["Abilities"]["Strength"] = 2
        RACE_DEFINITIONS["Dwarf"]["Armor Proficiencies"] = ["Light",
                                                            "Medium"]
    else:
...
def subrace_elf(subrace):
    ...
    if "High" in subrace:
        RACE_DEFINITIONS["Elf"]["Abilities"]["Intelligence"] = 1
        RACE_DEFINITIONS["Elf"]["Weapon Proficiencies"] = [
            "Longsword", "Shortsword", "Shortbow", "Longbow"
            ]
        RACE_DEFINITIONS["Elf"]["Powers"].append({
            "Name": "Extra cantrip",
            "Text": "You know one extra cantrip of your choice from the "
                    "wizard spell list. Intelligence is your spellcasting "
                    "ability for it"
            })
        RACE_DEFINITIONS["Elf"]["Languages"].append("One extra")
    elif "Wood" in subrace:
        RACE_DEFINITIONS["Elf"]["Abilities"]["Wisdom"] = 1
        RACE_DEFINITIONS["Elf"]["Weapon Proficiencies"] = [
            "Longsword", "Shortsword", "Shortbow", "Longbow"
            ]
        RACE_DEFINITIONS["Elf"]["Powers"].append({
        ...
        RACE_DEFINITIONS["Elf"]["Abilities"]["Charisma"] = 1
        RACE_DEFINITIONS["Elf"]["Darkvision"] = 120
        RACE_DEFINITIONS["Elf"]["Powers"].append({
...
def subrace_halfling(subrace):
    ...
    if "Lightfoot" in subrace:
        RACE_DEFINITIONS["Halfling"]["Abilities"]["Charisma"] = 1
        RACE_DEFINITIONS["Halfling"]["Powers"].append({
        ...
        RACE_DEFINITIONS["Halfling"]["Abilities"]["Constitution"] = 1
        RACE_DEFINITIONS["Halfling"]["Powers"].append({
...
def subrace_gnome(subrace):
    ...
    if "Forest" in subrace:
        RACE_DEFINITIONS["Gnome"]["Abilities"]["Dexterity"] = 1
        RACE_DEFINITIONS["Gnome"]["Powers"].append({
        ...
        RACE_DEFINITIONS["Gnome"]["Abilities"]["Constitution"] = 1
        RACE_DEFINITIONS["Gnome"]["Powers"].append({
